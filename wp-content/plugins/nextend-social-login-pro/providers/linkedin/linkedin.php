...
class NextendSocialPROProviderLinkedIn extends NextendSocialProviderOAuth {
    ...
    const requiredApi = 'Advertising API';

    protected $sync_fields = array(
        'localizedHeadline' => array(
            'label'       => 'Headline',
            'node'        => 'basicprofile',
            'scope'       => 'r_basicprofile',
            'description' => self::requiredApi,
        ),
        'vanityName'        => array(
            'label'       => 'Vanity name',
            'node'        => 'basicprofile',
    ...
    public function getBasicProfile() {
        $extra_fields = apply_filters('nsl_linkedin_sync_node_fields', array(), 'basicprofile');
    ...
    public function getProviderEmailVerificationStatus() {
        /**
         * The email address (when) returned by LinkedIn
         * is always verified
         */
        return true;
    }
